 ;;(package-initialize) ;; this produces => Warning emacs package.el loaded before elpaca reddit
 (org-babel-load-file
 (expand-file-name
  "config.org"
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(verilog-ext use-package emacsql-psql org-roam-ql-ql org-tree-slide verilog-mode cmake-mode)))
(custom-set-faces
